...
namespace RayAdas {
	...
	void OpenGLRendererAPI::DrawIndexed(const SRef<VertexArray>& vertexArray, uint32_t indexCount)
	{
		vertexArray->Bind();
	...
	void OpenGLRendererAPI::DrawLines(const SRef<VertexArray>& vertexArray, uint32_t vertexCount)
	{
		vertexArray->Bind();
