...
namespace RayAdas {
	...
	static RenderUtilsStorage* s_Data;

	void RenderUtils::Init()
	{
		RA_PROFILE_FUNCTION();

		s_Data = new RenderUtilsStorage();
		...
		SRef<VertexBuffer> squareVB = VertexBuffer::Create(squareVertices, sizeof(squareVertices));
		squareVB->SetLayout({
		...
		SRef<IndexBuffer> squareIB = IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
		...
		s_Data->TextureShader = Shader::Create("../RayAdas-App/resources/shaders/Texture.glsl");
