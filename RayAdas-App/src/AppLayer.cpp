...
namespace RayAdasApp {
	AppLayer::AppLayer()
		: Layer("AppLayer"), m_CameraController(1280.0f / 720.0f)
	{
		...
		m_Texture = RayAdas::Texture2D::Create("assets/textures/Checkerboard.png");
		m_ChernoLogoTexture = RayAdas::Texture2D::Create("assets/textures/ChernoLogo.png");
	...
	void AppLayer::OnUpdate(RayAdas::Timestep ts)
	{
		// Update
	...
	void AppLayer::OnEvent(RayAdas::Event& e)
	{
